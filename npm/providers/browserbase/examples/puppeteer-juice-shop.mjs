...
import { connectBrowserbasePuppeteer } from "pentestkit/providers/browserbase";
import {
  printPtkProviderExampleSummary,
  runPtkProviderExample
} from "../../_shared/examples/run-ptk-example.mjs";

const cloud = await connectBrowserbasePuppeteer();
try {
  ...
  const summary = await runPtkProviderExample({
    ...
    project: "juice-shop-browserbase-puppeteer",
    resultsDir: ".runs/browserbase/puppeteer",
